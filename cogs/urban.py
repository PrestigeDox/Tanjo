...
class UrbanDictionary:
	def __init__(self, bot):
		...
		self.icon_uri = 'http://www.packal.org/sites/default/files/public/styles/icon_large/public/workflow-files/florianurban/icon/icon.png'
		self.color = bot.user_color

	@staticmethod
	async def get_definitions(term: str, limit: int = 1) -> dict:
